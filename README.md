...
```bash
docker run -it --name mongodb ghcr.io/cleanstart-containers/mongodb:latest
```
...
```bash
docker run -v /app:/app ghcr.io/cleanstart-containers/mongodb:latest
```

Port Forwarding Run with custom port mappings

```bash
docker run -p 8080:8080 ghcr.io/cleanstart-containers/mongodb:latest
```
